...
class SearchState extends State<Search> {
  DatabaseHelper databaseHelper = DatabaseHelper("Dutch");
  ...
  refetchList(language, db) async {
    if (_modeToEnglish) {
      List<Map<String, Object?>> items =
          await databaseHelper.search(_querry, language, db);
          ...
          children: [
            ...
            TextField(
              onChanged: (value) async {
                List<Map<String, Object?>> items =
                    await databaseHelper.search(value, _language, db);
                setState(() {
                  _items = items;
                  _querry = value;
                });
                    ...
                    return ListTile(
                      ...
                      onTap: () async {
                        Map wordData = await databaseHelper.getById(
                            _items[index]["id"] as int, _language, db);
